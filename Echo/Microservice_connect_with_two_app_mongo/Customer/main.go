...
func main(){
	...
	clientOptions := options.Client().ApplyURI("mongodb://mongoadmin:abc123@mongoservice:27017")
    ...
    // client1, err := mongo.Connect(ctx1, clientOptions1)
    // if err != nil {
    //     log.Fatal(err)
    // }

    // err = client1.Ping(ctx1, nil)
    // if err != nil {
    //     log.Fatal(err)
    // }
